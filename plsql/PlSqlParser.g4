...
other_function
    ...
    | TRUNC '(' ( numeric| general_element ) ((SOLIDUS|PLUS_SIGN|MINUS_SIGN|ASTERISK) ( numeric| general_element ))? ')'
    | MOD '(' (numeric_function_wrapper|other_function | general_element) COMMA numeric ')' 
     ;
